...
whole cycle (no duplicate landfall, only one spellslinger, etc.). Kindred/typal is a *rationed*
...
| Identity | Commander | Archetype |
|---|---|---|
| WU Azorius | Errant & Giada *(pre-built)* | Flash / flyers value |
...
| UBR Grixis | Marchesa villains *(pre-built)* | Villain-typal |
...
| Identity | Commander | Archetype |
|---|---|---|
| WUBRG | The Wandering Minstrel *(built)* | Landfall / go-wide |
...
- **Pre-built decks that fill a slot:** Errant & Giada (WU) and Marchesa villains (UBR) are
  ...
  off-limits as *themes* to reuse elsewhere: Shirei (mono-B sac/reanimate/aristocrats),
