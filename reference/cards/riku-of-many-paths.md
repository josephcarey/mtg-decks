# Card knowledge cache — Riku of Many Paths

Real card text pinned from Scryfall bulk data (oracle_cards, updated 2026-09-11T21:00:34.893+00:00). Regenerate with `bun run deck gen-reference`.

Cards: 86
## Riku of Many Paths

- **Mana cost:** {G}{U}{R} · **MV:** 3
...
- **Mana cost:** {3}{R} · **MV:** 4
- **Type:** Creature — Orc Shaman Sorcerer
